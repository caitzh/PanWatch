  ...
  const builtinTemplates: Array<{ name: string; desc: string; payload: TemplatePayload }> = [
    {
      ...
      payload: {
        ...
        agents: [
          ...
          { name: 'intraday_monitor', enabled: true, schedule: '*/10 9-15 * * 1-5', execution_mode: 'single', config: { event_only: true, price_alert_threshold: 4.0, volume_alert_ratio: 2.5, throttle_minutes: 45, enable_chart_screenshot: false, screenshot_period: 'daily' } },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        agents: [
          { name: 'premarket_outlook', enabled: true, schedule: '30 8 * * 1-5', execution_mode: 'batch' },
          { name: 'daily_report', enabled: true, schedule: '30 15 * * 1-5', execution_mode: 'batch' },
          { name: 'intraday_monitor', enabled: true, schedule: '*/5 9-15 * * 1-5', execution_mode: 'single', config: { event_only: true, price_alert_threshold: 3.0, volume_alert_ratio: 2.0, throttle_minutes: 30, enable_chart_screenshot: false, screenshot_period: 'daily' } },
        ],
      },
    },
    {
      ...
      payload: {
        ...
        agents: [
          ...
          { name: 'intraday_monitor', enabled: true, schedule: '*/3 9-15 * * 1-5', execution_mode: 'single', config: { event_only: true, price_alert_threshold: 2.0, volume_alert_ratio: 1.8, throttle_minutes: 20, enable_chart_screenshot: false, screenshot_period: 'daily' } },
        ],
      },
    },
  ]
